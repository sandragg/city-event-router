...
template class tree::BfsIterator<list_of_siblings::Tree<tracer::RoutePoint<int>>>;
template class tree::DfsIterator<list_of_siblings::Tree<tracer::RoutePoint<int>>>;
